...
##### con esos graficos terminaria la primera parte exploratoria mas decriptiva, desde aca empezamos a buscar relaciones
...
# Incluimos la variable idh del dataset de la ONU
